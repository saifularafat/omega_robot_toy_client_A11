        ...
        <div className=' mb-16'>
            <div className='my_container'>
                <div className='text-center mt-20 mb-10'>
                    <h2 className='text-5xl font-Lobster font-semibold pb-3'>About Us</h2>
                    <p className='md:w-[480px] mx-auto text-lg font-open text-description-color'>The history of robotics for kids can be traced back to the emergence of educational robotics in the late 20th century. Here are some key milestones and developments.</p>
                </div>

                <div className='grid md:grid-cols-2'>
                    <div>
                        <img src={robot6} alt=""
                            className='rounded-r-xl md:w-full md:h-[440px] ml-2' />
                    </div>

                    <div className='relative mt-12 ml-10'>
                        <div className='md:flex flex-row-reverse justify-around'>
                            <div>
                                <img src={robot3} alt="" className='md:h-64 w-full ' />
                            </div>
                            <div>
                                <img src={robot4} alt="" className='md:h-64 w-full ' />
                            </div>
                        </div>
