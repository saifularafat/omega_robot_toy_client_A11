...
const Blog = () => {
    return (
        <div className="my_container my-10 card bg-base-100 shadow-xl">
            <div className="card-body">
                <div className="space-y-4 mb-4">
                    ...
                    <p>
                        ...
                        the authenticated user. The access token is typically short-lived
                        and has an expiration time. It is included in the requests made by
                        the client to the server, usually in the Authorization header or as
                    ...
                    <p>
                        ...
                        access token expires without requiring the user to reauthenticate.
                        The refresh token is securely stored by the client (usually in a
                    ...
                    <p>
                        ...
                        perform authorized actions.The server verifies the access token for
                        each request to ensure the client is authorized to access the
                        requested resource. This can be done by checking the token is
                    ...
                    <p>
                        ...
                        the user to reauthenticate. The client sends a request to the server
                        with the refresh token to obtain a new access token.The server
                        verifies the refresh token and, if valid and not expired, issues a
                        new access token to the client.The client replaces the expired
